    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <nav className="bg-gray-900 border-b border-gray-800 px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs bg-amber-500/15 text-amber-400 border border-amber-500/25 px-2.5 py-0.5 rounded-full font-semibold">
            Admin
          </span>
        </div>
        <Link href="/contacts" className="text-sm text-gray-500 hover:text-white transition-colors">
          ← Back to app
        </Link>
      </nav>
