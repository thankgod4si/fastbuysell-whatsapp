...
function getMessagePreview(msg: MsgLog) {
  if (!msg) return ''
  switch (msg.msg_type) {
    case 'text': return msg.content || ''
    case 'template': return '📨 Outreach sent'
    case 'image': return '📷 Image'
    case 'form_submission': return '📋 Form submitted'
    case 'button_reply': return msg.content || '🔘 Button tapped'
    case 'payment_prompt': return '💳 Payment requested'
    case 'bank_details': return '🏦 Bank details sent'
              ...
              <Link key={item.id} href={href}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[#8E8E93] truncate mt-0.5">
                    {isInbound ? '' : '↩ '}{getMessagePreview(item)}
                  </p>
                </div>
